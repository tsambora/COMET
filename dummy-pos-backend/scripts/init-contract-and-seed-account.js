...
contractObject.getContractInstance(commonwealthAddr, [10000000])
  .then((contractInstance) => {
    ...
    var rsv = EthUtils.getRSVFromSignature(web3, commonwealthToMerchantSign.substr(2))
    contractInstance.transfer(commonwealthAddr, merchantAddr, 1000, commonwealthToMerchantToken, rsv.v, rsv.r, rsv.s)
    ...
    var rsv = EthUtils.getRSVFromSignature(web3, commonwealthToBuyerSign.substr(2))
    contractInstance.transfer(commonwealthAddr, buyerAddr, 1000, commonwealthToBuyerToken, rsv.v, rsv.r, rsv.s)
